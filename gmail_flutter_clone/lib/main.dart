...
import 'package:gmail_flutter_clone/screens/splash_screen.dart';
...
void main() async {
  ...
  runApp(MultiProvider(
    providers: [Provider(create: (_) => AuthProvider())],
    child: MyApp(),
  ));
}
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        ComposeEmailScreen.id: (context) => ComposeEmailScreen(),
      },
    );
  }
}
